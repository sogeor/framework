 ...
 * — однако способно содержать {@code 4611686018427387903} элементов. Данное ограничение не создаст проблем в ближайшем
 * будущем, так как для хранения даже такого количества элементов размером {@code 1} байт потребуется {@code 4}
 * эксбибайт.
 *
