 ...
 * @since 1.0.0-RC1
 */
public interface ImmutableSequencedCollection<T> extends ImmutableCollection<T>, ReadableSequencedCollection<T> {
     ...
     * @since 1.0.0-RC1
     */
    interface Iterator<T> extends ImmutableCollection.Iterator<T>, ReadableSequencedCollection.Iterator<T> {}
