...
/**
 * Представляет собой абстрактный итератор элементов множества.
 *
 ...
 * @since 1.0.0-RC1
 */
public abstract class AbstractSetIterator<T> extends AbstractIterator<T> implements SetIterator<T> {
     ...
     * @since 1.0.0-RC1
     */
    protected AbstractSetIterator(final @NonNull ImmutableSet<@NonNull IteratorFeature> features) {
        super(features);
    }
