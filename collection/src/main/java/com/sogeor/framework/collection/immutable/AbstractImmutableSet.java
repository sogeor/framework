...
public abstract class AbstractImmutableSet<T> extends AbstractReadableSet<T> implements ImmutableSet<T> {
    ...
    /**
     * Представляет собой абстрактный итератор элементов абстрактного неизменяемого множества.
     *
     * @param <T> тип элементов.
     *
     ...
     * @since 1.0.0-RC1
     */
    public abstract static class AbstractIterator<T> extends AbstractReadableSet.AbstractIterator<T> implements ImmutableSet.Iterator<T> {
