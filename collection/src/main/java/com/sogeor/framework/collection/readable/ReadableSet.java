 ...
 * @since 1.0.0-RC1
 */
public interface ReadableSet<T> extends ReadableUnsequencedCollection<T>, Set<T> {
     ...
     * @since 1.0.0-RC1
     */
    interface Iterator<T> extends ReadableUnsequencedCollection.Iterator<T>, Set.Iterator<T> {}
