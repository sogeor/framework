 ...
 * @since 1.0.0-RC1
 */
public interface ReadableIterableCollection<T> extends ReadableCollection, IterableCollection<T> {
     ...
     */
    @Contract("? -> value")
    default boolean contains(final @NonNull ReadableIterableCollection<T> elements) throws ValidationFault {
        Validator.nonNull(elements, "The passed elements");
