 ...
 * <p>
 * У каждой коллекции есть размер и вместимость. Размер — это количество элементов, которые содержатся в коллекции на
 * данный момент, вместимость — это максимальный размер коллекции. Чтобы повысить эффективность работы с памятью,
 * существуют методы для изменения вместимости коллекции: {@link #shrink()} и {@linkplain #expand(long)}.
 *
 * @since 1.0.0-RC1
 */
