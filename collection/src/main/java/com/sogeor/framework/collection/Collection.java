...
public interface Collection<T> {
     ...
     *
     * @implSpec Строковое представление этой коллекции должно включать в себя, если возможно, строковые представления
     * всех её элементов, в противном случае хотя бы их количество.
     * @since 1.0.0-RC1
     */
    @Override
    @Contract("-> value")
