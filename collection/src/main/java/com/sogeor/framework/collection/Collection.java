 ...
 * <p>
 * Также коллекции бывают упорядоченными и неупорядоченными. Первые гарантируют определённый порядок элементов, но чаще
 * всего только до момента изменения коллекции. Вторые не гарантируют порядок, но он всё равно может возникнуть.
 *
 * @since 1.0.0-RC1
 */
public interface Collection {
    ...
    /**
     * Вычисляет хеш-код на основе элементов этой коллекции и возвращает его.
     *
