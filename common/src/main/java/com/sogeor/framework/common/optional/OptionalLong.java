...
import com.sogeor.framework.common.optional.immutable.ImmutableLong;
import com.sogeor.framework.common.optional.mutable.MutableLong;
...
/**
 * Представляет собой обёртку над значением типа {@code long}.
 *
 * @see #present(Action)
 * @since 1.0.0-RC1
 */
public abstract sealed class OptionalLong extends Optional permits ImmutableLong, MutableLong {
    ...
    /**
     * Если {@code present()}, то возвращает текущее значение типа {@code long}, иначе — {@code 0}.
     *
    ...
    public <F extends Throwable> @NonNull OptionalLong absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                      F {
        super.absent(action);
        return this;
    }
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalLong present(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                       F {
     ...
     */
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalLong present(final @NonNull LongConsumer<F> consumer) throws
                                                                                                        ValidationFault,
                                                                                                        F {
     ...
     * <p>
     * Если {@code object instanceof OptionalLong that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull OptionalLong that && present() == that.present() &&
                                 (absent() || get() == that.get());
    }
