...
import com.sogeor.framework.common.optional.immutable.ImmutableDouble;
import com.sogeor.framework.common.optional.mutable.MutableDouble;
...
/**
 * Представляет собой обёртку над значением типа {@code double}.
 *
 * @see #present(Action)
 * @since 1.0.0-RC1
 */
public abstract sealed class OptionalDouble extends Optional permits ImmutableDouble, MutableDouble {
    ...
    /**
     * Если {@code present()}, то возвращает текущее значение типа {@code double}, иначе — {@code 0}.
     *
    ...
    public <F extends Throwable> @NonNull OptionalDouble absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                        F {
        super.absent(action);
        return this;
    }
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalDouble present(final @NonNull Action<F> action) throws
                                                                                                  ValidationFault, F {
     ...
     */
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalDouble present(final @NonNull DoubleConsumer<F> consumer) throws
                                                                                                            ValidationFault,
                                                                                                            F {
     ...
     * <p>
     * Если {@code object instanceof OptionalDouble that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull OptionalDouble that && present() == that.present() &&
                                 (absent() || get() == that.get());
    }
