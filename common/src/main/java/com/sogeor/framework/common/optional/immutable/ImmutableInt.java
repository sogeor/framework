 ...
 * @since 1.0.0-RC1
 */
public final class ImmutableInt extends OptionalInt {
     ...
     * @since 1.0.0-RC1
     */
    private static final @NonNull ImmutableInt EMPTY = new ImmutableInt();
    ...
    private ImmutableInt() throws SingletonCreationFault {
     ...
     */
    @Contract("? -> new")
    private ImmutableInt(final int value) {
        contains = true;
        this.value = value;
    }
     ...
     */
    @Contract("-> $!null")
    public static @NonNull ImmutableInt empty() {
        return EMPTY;
    }
     ...
     */
    @Contract("? -> new")
    public static @NonNull ImmutableInt of(final int value) {
    ...
    public <F extends Throwable> @NonNull ImmutableInt absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                      F {
        super.absent(action);
        return this;
    }
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull ImmutableInt present(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                       F {
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull ImmutableInt present(final @NonNull IntConsumer<F> consumer) throws
                                                                                                       ValidationFault,
                                                                                                       F {
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull ImmutableInt that && contains == that.contains &&
