...
import com.sogeor.framework.common.optional.immutable.ImmutableBoolean;
import com.sogeor.framework.common.optional.mutable.MutableBoolean;
...
/**
 * Представляет собой обёртку над значением типа {@code boolean}.
 *
 * @see #present(Action)
 * @since 1.0.0-RC1
 */
public abstract sealed class OptionalBoolean extends Optional permits ImmutableBoolean, MutableBoolean {
    ...
    /**
     * Если {@code present()}, то возвращает текущее значение типа {@code boolean}, иначе — {@code 0}.
     *
    ...
    public <F extends Throwable> @NonNull OptionalBoolean absent(final @NonNull Action<F> action) throws
                                                                                                  ValidationFault, F {
        super.absent(action);
        return this;
    }
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalBoolean present(final @NonNull Action<F> action) throws
                                                                                                   ValidationFault, F {
     ...
     */
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalBoolean present(final @NonNull BooleanConsumer<F> consumer) throws
                                                                                                              ValidationFault,
                                                                                                              F {
     ...
     * <p>
     * Если {@code object instanceof OptionalBoolean that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull OptionalBoolean that && present() == that.present() &&
                                 (absent() || get() == that.get());
    }
