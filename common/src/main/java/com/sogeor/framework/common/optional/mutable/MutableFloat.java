...
import com.sogeor.framework.common.optional.OptionalFloat;
import com.sogeor.framework.function.Action;
import com.sogeor.framework.function.FloatConsumer;
import com.sogeor.framework.function.FloatSupplier;
import com.sogeor.framework.function.FloatToFloatHandler;
...
/**
 * Представляет собой изменяемую обёртку над значением типа {@code float}.
 * <p>
 * Изменяемая обёртка основана на паре блокировок для чтения и записи, поэтому она обеспечивает правильный доступ к
 * значению типа {@code float} и его существованию даже в многопоточной среде.
 *
 * @since 1.0.0-RC1
 */
public final class MutableFloat extends OptionalFloat {
    ...
    /**
     * Если текущее значение типа {@code float} существует, то содержит {@code true}, иначе — {@code false}.
     *
     * @since 1.0.0-RC1
     */
    ...
    /**
     * Содержит текущее значение типа {@code float}.
     *
     * @since 1.0.0-RC1
     */
    private float value;
    ...
    /**
     * Создаёт экземпляр без значения типа {@code float}.
     *
     * @since 1.0.0-RC1
     */
    @Contract("-> new")
     ...
     */
    @Contract("? -> new")
    private MutableFloat(final float value) {
        contains = true;
        this.value = value;
    }

    /**
     * Создаёт изменяемую обёртку без значения типа {@code float}.
     *
     * @return Новую изменяемую обёртку без значения типа {@code float}.
     *
     * @since 1.0.0-RC1
     */
    @Contract("-> new")
    public static @NonNull MutableFloat empty() {
     ...
     */
    @Contract("? -> new")
    public static @NonNull MutableFloat of(final float value) {
     ...
     * {@inheritDoc}
     *
     * @return Текущее значение типа {@code float} или {@code 0}.
     *
     * @since 1.0.0-RC1
     */
    @Override
     ...
     */
    @Contract("? -> this")
    public @NonNull MutableFloat reset() {
     ...
     */
    @Contract("? -> this")
    public @NonNull MutableFloat set(final float value) {
        final @NonNull var lock = this.lock.writeLock();
        lock.lock();
        contains = true;
        this.value = value;
     ...
     * @see #value
     * @see FloatToFloatHandler#handle(float)
     * @since 1.0.0-RC1
     */
    @Experimental
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableFloat set(final @NonNull FloatToFloatHandler<F> handler) throws
                                                                                                          ValidationFault,
                                                                                                          F {
     ...
     * @see #value
     * @see FloatSupplier#get()
     * @since 1.0.0-RC1
     */
    @Experimental
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableFloat set(final @NonNull FloatSupplier<F> supplier) throws
                                                                                                     ValidationFault,
                                                                                                     F {
    ...
    /**
     * Если текущее значение типа {@code float} не существует, то возвращает {@code true}, иначе — {@code false}.
     *
    ...
    /**
     * Если текущее значение типа {@code float} существует, то возвращает {@code true}, иначе — {@code false}.
     *
     * @return {@code contains}.
     *
     * @see #contains
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableFloat absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                      F {
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableFloat present(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                       F {
        Validator.nonNull(action, "The passed action");
        final @NonNull var lock = this.lock.readLock();
        lock.lock();
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableFloat present(final @NonNull FloatConsumer<F> consumer) throws
                                                                                                         ValidationFault,
                                                                                                         F {
     ...
     * <p>
     * Если {@code object instanceof MutableFloat that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull MutableFloat that && present() == that.present() &&
                                 (absent() || get() == that.get());
    }
