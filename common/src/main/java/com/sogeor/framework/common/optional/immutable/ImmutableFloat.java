...
/**
 * Представляет собой неизменяемую обёртку над значением типа {@code float}.
 *
 * @since 1.0.0-RC1
 */
public final class ImmutableFloat extends OptionalFloat {

    /**
     * Содержит неизменяемую обёртку без значения типа {@code float}.
     *
     * @see #ImmutableFloat()
     * @since 1.0.0-RC1
     */
    private static final @NonNull ImmutableFloat EMPTY = new ImmutableFloat();
     ...
     */
    @Contract("? -> new")
    private ImmutableFloat(final float value) {
        contains = true;
        this.value = value;
    }

    /**
     * @return Неизменяемую обёртку без значения типа {@code float}.
     *
     * @see #EMPTY
     * @since 1.0.0-RC1
     */
    @Contract("-> $!null")
    public static @NonNull ImmutableFloat empty() {
        return EMPTY;
    }
     ...
     */
    @Contract("? -> new")
    public static @NonNull ImmutableFloat of(final float value) {
    ...
    public <F extends Throwable> @NonNull ImmutableFloat absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                        F {
        super.absent(action);
        return this;
    }
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull ImmutableFloat present(final @NonNull Action<F> action) throws
                                                                                                  ValidationFault, F {
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull ImmutableFloat present(final @NonNull FloatConsumer<F> consumer) throws
                                                                                                           ValidationFault,
                                                                                                           F {
     ...
     * <p>
     * Если {@code object instanceof ImmutableFloat that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull ImmutableFloat that && contains == that.contains &&
