...
import com.sogeor.framework.common.optional.immutable.ImmutableChar;
import com.sogeor.framework.common.optional.mutable.MutableChar;
...
/**
 * Представляет собой обёртку над значением типа {@code char}.
 *
 * @see #present(Action)
 * @since 1.0.0-RC1
 */
public abstract sealed class OptionalChar extends Optional permits ImmutableChar, MutableChar {
     ...
     */
    @Contract("-> new")
    protected OptionalChar() {}

    /**
     * Если {@code present()}, то возвращает текущее значение типа {@code char}, иначе — {@code 0}.
     *
    ...
    public <F extends Throwable> @NonNull OptionalChar absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                      F {
        super.absent(action);
        return this;
    }
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalChar present(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                       F {
     ...
     */
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull OptionalChar present(final @NonNull CharConsumer<F> consumer) throws
                                                                                                        ValidationFault,
                                                                                                        F {
     ...
     * <p>
     * Если {@code object instanceof OptionalChar that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull OptionalChar that && present() == that.present() &&
                                 (absent() || get() == that.get());
    }
