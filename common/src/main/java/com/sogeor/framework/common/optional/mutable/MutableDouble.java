...
import com.sogeor.framework.function.DoubleSupplier;
import com.sogeor.framework.function.DoubleToDoubleHandler;
...
/**
 * Представляет собой изменяемую обёртку над значением типа {@code double}.
 * <p>
 * Изменяемая обёртка основана на паре блокировок для чтения и записи, поэтому она обеспечивает правильный доступ к
 * значению типа {@code double} и его существованию даже в многопоточной среде.
 *
 * @since 1.0.0-RC1
 */
public final class MutableDouble extends OptionalDouble {
    ...
    /**
     * Создаёт экземпляр без значения типа {@code double}.
     *
     * @since 1.0.0-RC1
     */
    @Contract("-> new")
     ...
     */
    @Contract("? -> new")
    private MutableDouble(final double value) {
        contains = true;
        this.value = value;
    }

    /**
     * Создаёт изменяемую обёртку без значения типа {@code double}.
     *
     * @return Новую изменяемую обёртку без значения типа {@code double}.
     *
     * @since 1.0.0-RC1
     */
    @Contract("-> new")
    public static @NonNull MutableDouble empty() {
     ...
     */
    @Contract("? -> new")
    public static @NonNull MutableDouble of(final double value) {
     ...
     */
    @Contract("? -> this")
    public @NonNull MutableDouble reset() {
     ...
     */
    @Contract("? -> this")
    public @NonNull MutableDouble set(final double value) {
        final @NonNull var lock = this.lock.writeLock();
        lock.lock();
        contains = true;
        this.value = value;
     ...
     * @see #value
     * @see DoubleToDoubleHandler#handle(double)
     * @since 1.0.0-RC1
     */
    @Experimental
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableDouble set(final @NonNull DoubleToDoubleHandler<F> handler) throws
                                                                                                             ValidationFault,
                                                                                                             F {
     ...
     * @see #value
     * @see DoubleSupplier#get()
     * @since 1.0.0-RC1
     */
    @Experimental
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableDouble set(final @NonNull DoubleSupplier<F> supplier) throws
                                                                                                       ValidationFault,
                                                                                                       F {
    ...
    /**
     * Если текущее значение типа {@code double} не существует, то возвращает {@code true}, иначе — {@code false}.
     *
    ...
    /**
     * Если текущее значение типа {@code double} существует, то возвращает {@code true}, иначе — {@code false}.
     *
     * @return {@code contains}.
     *
     * @see #contains
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableDouble absent(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                       F {
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableDouble present(final @NonNull Action<F> action) throws ValidationFault,
                                                                                                        F {
        Validator.nonNull(action, "The passed action");
        final @NonNull var lock = this.lock.readLock();
        lock.lock();
    ...
    @Override
    @Contract("!null -> this; null -> fault")
    public <F extends Throwable> @NonNull MutableDouble present(final @NonNull DoubleConsumer<F> consumer) throws
                                                                                                           ValidationFault,
                                                                                                           F {
     ...
     * <p>
     * Если {@code object instanceof MutableDouble that}, то возвращает
    ...
    public boolean equals(final @Nullable Object object) {
        return this == object || object instanceof final @NonNull MutableDouble that && present() == that.present() &&
                                 (absent() || get() == that.get());
    }
