 ...
 * генерирует элемент при определённых аргументах.
 *
 * @since 1.0.0-RC1
 */
@Documented
...
public @interface Contract {
     ...
     *         <ul>
     *             <li>
     *                 {@code this} — это признак аргумента, являющегося ссылкой на экземпляр родительского типа
     *                 элемента.
     *             </li>
     *             <li>
     ...
     *             </li>
     *             <li>
     *                 {@code ?} — это признак неопределённого возвращаемого значения либо программного сбоя или
     ...
     *                 родительского типа элемента возвращаемого значения либо программного сбоя или неисправности.
     *                 Значение либо может быть или не быть {@code this}, либо может быть или не быть {@code null}, либо
     *                 может быть {@code false} или {@code true}, может быть определённым аргументом элемента.
     *             </li>
     *             <li>
     ...
     *                 родительского типа элемента возвращаемого значения. Значение либо может быть или не быть
     ...
     *             </li>
     *             <li>
     *                 {@code $!null} — это признак постоянного в течение существования экземпляра родительского типа
