 ...
 * порождающему шаблону проектирования — строителю.
 *
 * @see BuilderCreationFault
 * @see BuilderInstanceFault
 * @since 1.0.0-RC1
 */
public class BuilderFault extends UncheckedFault {
     ...
     */
    @Contract("?, ?, ?, ? -> new")
    public BuilderFault(final @Nullable String message, final @Nullable Throwable cause, final boolean suppression,
