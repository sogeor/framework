...
/**
 * Представляет собой проверяемый программный сбой, связанный с созданием экземпляра утилитарного класса.
 *
 * @since 1.0.0-RC1
 */
public class UtilityCreationFailure extends UtilityFailure {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "An instance of the `%s` utility class must not be created";
