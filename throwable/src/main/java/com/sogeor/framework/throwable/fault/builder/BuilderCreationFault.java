...
/**
 * Представляет собой непроверяемую программную неисправность, связанную с созданием экземпляра класса,
 * спроектированного согласно порождающему шаблону проектирования — строителю.
 *
 * @see BuilderInstanceFault
 * @since 1.0.0-RC1
 */
public class BuilderCreationFault extends BuilderFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String DEFAULT_MESSAGE = "Failed to create an instance of the builder class";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "Failed to create an instance of the `%s` builder class";
     ...
     */
    @Contract("?, ? -> new")
    public BuilderCreationFault(final boolean suppression, final boolean stackTrace) {
