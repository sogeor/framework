...
package com.sogeor.framework.throwable.fault.builder;
...
/**
 * Представляет собой непроверяемую программную неисправность, связанную с созданием экземпляра составного класса
 * посредством экземпляра класса, спроектированного согласно порождающему шаблону проектирования — строителю.
 *
 * @see BuilderCreationFault
 * @since 1.0.0-RC1
 */
public class BuilderInstanceFault extends BuilderFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String DEFAULT_MESSAGE = "Failed to create an instance of the composite class using the instance of the builder class";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "Failed to create an instance of the `%s` composite class using the instance of the `%s` builder class";
     ...
     */
    @Contract("? -> new")
    public BuilderInstanceFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public BuilderInstanceFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public BuilderInstanceFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public BuilderInstanceFault(final boolean suppression, final boolean stackTrace) {
