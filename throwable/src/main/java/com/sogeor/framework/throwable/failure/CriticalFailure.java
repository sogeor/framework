...
/**
 * Представляет собой непроверяемый программный сбой, связанный с критическими ситуациями.
 *
 * @since 1.0.0-RC1
 */
@Experimental
public class CriticalFailure extends UncheckedFailure {
     ...
     */
    @Contract("?, ?, ?, ? -> new")
    public CriticalFailure(final @Nullable String message, final @Nullable Throwable cause, final boolean suppression,
