 ...
 * значения, которое должно быть меньше вторичного или больше третичного.
 *
 * @since 1.0.0-RC1
 */
public class NotOutsideValidationFault extends ValidationFault {
     ...
     */
    @Contract("?, ? -> new")
    public NotOutsideValidationFault(final boolean suppression, final boolean stackTrace) {
