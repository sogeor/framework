 ...
 * @since 1.0.0-RC1
 */
public class InfiniteValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be infinite";
     ...
     */
    @Contract("-> new")
    public InfiniteValidationFault() {
     ...
     */
    @Contract("? -> new")
    public InfiniteValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public InfiniteValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public InfiniteValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public InfiniteValidationFault(final boolean suppression, final boolean stackTrace) {
