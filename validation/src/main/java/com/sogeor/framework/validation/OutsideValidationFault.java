 ...
 * значения, которое не должно быть меньше вторичного или больше третичного.
 *
 * @since 1.0.0-RC1
 */
public class OutsideValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be less than %s or more than %s";
