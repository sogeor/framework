 ...
 * @since 1.0.0-RC1
 */
public class NumberValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be a number";
     ...
     */
    @Contract("? -> new")
    public NumberValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public NumberValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NumberValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NumberValidationFault(final boolean suppression, final boolean stackTrace) {
