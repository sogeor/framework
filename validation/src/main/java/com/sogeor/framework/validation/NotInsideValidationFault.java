 ...
 * {@code byte}, {@code short}, {@code int}, {@code long}, {@code float} и {@code double}, которое должно быть больше
 * вторичного и меньше третичного.
 *
 * @since 1.0.0-RC1
 */
public class NotInsideValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must be more than %s and less than %s";
     ...
     */
    @Contract("-> new")
    public NotInsideValidationFault() {
     ...
     */
    @Contract("? -> new")
    public NotInsideValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public NotInsideValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NotInsideValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NotInsideValidationFault(final boolean suppression, final boolean stackTrace) {
