 ...
 * {@code byte}, {@code short}, {@code int}, {@code long}, {@code float} и {@code double}, которое не должно быть больше
 * вторичного.
 *
 * @since 1.0.0-RC1
 */
public class MoreValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be more than %s";
     ...
     */
    @Contract("? -> new")
    public MoreValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public MoreValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public MoreValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public MoreValidationFault(final boolean suppression, final boolean stackTrace) {
