 ...
 * значения, которое не должно быть меньше вторичного.
 *
 * @since 1.0.0-RC1
 */
public class LessValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be less than %s";
     ...
     */
    @Contract("? -> new")
    public LessValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public LessValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public LessValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public LessValidationFault(final boolean suppression, final boolean stackTrace) {
