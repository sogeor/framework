 ...
 * {@code byte}, {@code short}, {@code int}, {@code long}, {@code float} и {@code double}, которое не должно быть
 * одновременно больше вторичного и меньше третичного.
 *
 * @see NotInsideValidationFault
 * @since 1.0.0-RC1
 */
public class InsideValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be more than %s and less than %s at the same time";
     ...
     */
    @Contract("? -> new")
    public InsideValidationFault(final @Nullable String message) {
        super(message);
    }
     ...
     */
    @Contract("? -> new")
    public InsideValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public InsideValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
        super(message, cause);
    }
