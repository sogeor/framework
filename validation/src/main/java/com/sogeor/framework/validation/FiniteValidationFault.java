 ...
 * @since 1.0.0-RC1
 */
public class FiniteValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must not be finite";
     ...
     */
    @Contract("? -> new")
    public FiniteValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public FiniteValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public FiniteValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public FiniteValidationFault(final boolean suppression, final boolean stackTrace) {
