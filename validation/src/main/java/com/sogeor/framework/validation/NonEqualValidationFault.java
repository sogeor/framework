...
/**
 * Представляет собой непроверяемую программную неисправность, связанную с неудачной валидацией равенства объектов или
 * значений.
 *
 * @since 1.0.0-RC1
 */
public class NonEqualValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String DEFAULT_OBJECTS_MESSAGE = "The objects must be equal";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String DEFAULT_VALUES_MESSAGE = "The values must be equal";
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must be equal";
     ...
     */
    @Contract("-> new")
    public NonEqualValidationFault() {
     ...
     */
    @Contract("? -> new")
    public NonEqualValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public NonEqualValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NonEqualValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NonEqualValidationFault(final boolean suppression, final boolean stackTrace) {
