 ...
 * @since 1.0.0-RC1
 */
public class NotMoreValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must be more than %s";
     ...
     */
    @Contract("? -> new")
    public NotMoreValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public NotMoreValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NotMoreValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NotMoreValidationFault(final boolean suppression, final boolean stackTrace) {
