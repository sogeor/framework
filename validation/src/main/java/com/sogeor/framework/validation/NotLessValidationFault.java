 ...
 * значения, которое должно быть меньше вторичного.
 *
 * @since 1.0.0-RC1
 */
public class NotLessValidationFault extends ValidationFault {
     ...
     * @since 1.0.0-RC1
     */
    public static final @NonNull String TEMPLATE_MESSAGE = "%s must be less than %s";
     ...
     */
    @Contract("? -> new")
    public NotLessValidationFault(final @Nullable String message) {
     ...
     */
    @Contract("? -> new")
    public NotLessValidationFault(final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NotLessValidationFault(final @Nullable String message, final @Nullable Throwable cause) {
     ...
     */
    @Contract("?, ? -> new")
    public NotLessValidationFault(final boolean suppression, final boolean stackTrace) {
